...
def _pooled_knn_prediction(
    train_data_matrix, train_labels_matrix, test_data, feature_indices, k, random_state
):
...
def segmentation_mymethod(
    train_data_matrix, train_labels_matrix, test_data, task="brain"
):
...
def segmentation_demo():
    ...
    for i in np.arange(num_images):
        ...
        predicted_labels = segmentation_mymethod(
            train_data_matrix, train_labels_matrix, test_data, task
        )
